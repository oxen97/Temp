...
export function useEditorShellStore() {
  return useEditorStore(
    useShallow((state) => ({
      ...
      applySceneBackgroundToAll: state.applySceneBackgroundToAll,
      ...
      setBackgroundMediaPreview: state.setBackgroundMediaPreview,
      ...
      updateSceneBackground: state.updateSceneBackground,
